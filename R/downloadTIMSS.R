...
downloadTIMSS <- function(root, years = c(2003, 2007, 2011, 2015, 2019), cache = FALSE, verbose = TRUE) {
  ...
  d2003 <- c(
    "https://timssandpirls.bc.edu/timss2003i/PDF/t03_spss_1.zip",
    "https://timssandpirls.bc.edu/timss2003i/PDF/t03_spss_2.zip"
  )

  d2007 <- c(
    "https://timssandpirls.bc.edu/TIMSS2007/PDF/T07_SPSS_G4_1.zip",
  ...
  d2011 <- c(
    "https://timssandpirls.bc.edu/timss2011/downloads/T11_G4_SPSSData_pt1.zip",
  ...
  d2015 <- c(
    "https://timssandpirls.bc.edu/timss2015/international-database/downloads/T15_G4_SPSSData_pt1.zip",
