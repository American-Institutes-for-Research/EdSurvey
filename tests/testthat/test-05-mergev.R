...
test_that("merge stats correct",{
  m1co <- c("Variables in both  dfa  and  dfb :",
            "[1] \"key2\"",
  ...
  m2co <- c("Variables in both  dfa  and  dfbu :",
            "[1] \"key2\"",
  ...
  m3co <- c("Variables in both  dfas  and  dfb :",
            "[1] \"key2\"",
            "Merge type is  one:many ", 
            "",
            " x only  y only matched ",
  ...
  m4co <- c("Variables in both  dfas  and  dfb :",
            "[1] \"key2\"",
            "Merge type is  one:many ", 
            "",
            " x only  y only matched ",
  ...
  m5co <- c("Variables in both  dfas  and  dfb :",
            "[1] \"key2\"",
            "Merge type is  one:many ",
            "",
            " x only  y only matched ",
  ...
  m6co <- c("Variables in both  dfas  and  dfb :",
            "[1] \"key2\"",
            "Merge type is  one:many ",
            "",
            " x only  y only matched ",
