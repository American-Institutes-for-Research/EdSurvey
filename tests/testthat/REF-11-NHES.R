...
dat1Summary.Ref <- c("E ELEMENTARY SCHOOL      H HOMESCHOOLER     M MIDDLE SCHOOL       S SENIOR HIGH ", 
                     "               6797                 397                3951                6418 ")

dat2Summary.Ref <- c("                 cpdays          p1sex                 p1mrsta    ", 
...
dat3Summary.Ref <- c("     eehrs               cenreg     ", 
...
dat4Summary.Ref <- c("                 p1rel           p1sex               cenreg    ", 
...
nhes_lm1 <- c("                                (Intercept)                        segrades2 MOSTLY B'S                        segrades3 MOSTLY C'S               segrades4 MOSTLY D'S OR LOWER segrades5 SCHOOL DOES NOT GIVE THESE GRADES ", 
              "                                  6.0924827                                  -0.6508287                                  -1.4458851                                  -1.1422074                                  -2.1719469 ")

nhes_lm2 <- c("                                                             (Intercept)                                      p1educ2 HIGH SCHOOL, BUT NO DIPLOMA                          p1educ3 HIGH SCHOOL DIPLOMA OR EQUIVALENT (GED)                             p1educ4 VOCATIONAL DIPLOMA AFTER HIGH SCHOOL                                      p1educ5 SOME COLLEGE, BUT NO DEGREE                                      p1educ6 ASSOCIATE'S DEGREE (AA, AS) ", 
...
nhes_gap1 <- c("Call: gap(variable = \"xxage\", data = ate2016rc, groupA = wkstatus == ", 
