...
es5REF <- c("",
            ...
            "   Male  2 or 3 times a week            Multiple   1   0.4306   0.04650645  0.04655901       NA        NA", 
            ...
            "   Male             Multiple             Omitted   1   2.4400  60.71615199 21.17715124       NA        NA", 
            ...
            " Female Never or hardly ever            Multiple   1   0.6698   0.05710145  0.05715608       NA        NA", 
            ...
            " Female              Omitted Did not finish H.S.   1   1.7223   2.13525117  2.07803300       NA        NA", 
            ...
            " Female             Multiple        I Don't Know   1   0.1435 100.00000000          NA       NA        NA", 
...
gap0REF <- c("Call: gap(variable = \"b003501\", data = sdf, groupA = m815401 %in% \"Multiple\", ", 
             ...
             "         0          NA   NA 0.2195458  0.06638235 9.756959 -0.2195458 4.505231e-06       NA           NA    NA")
...
gapPSUREF <- c("Call: gap(variable = \"composite\", data = sdf, groupA = dsex %in% \"Male\", ", 
               ...
               " 50.27015 0.5016796 49.72985 0.5016796 0.5402935 -0.2516824 1.003359    0.5924778 53.45667", "",
               "Results:",
...
sDiscreteREF <- c("Estimates are not weighted.",
                  "    dsex    N Percent",
                  "1   Male 8486   50.17", 
                  "2 Female 8429   49.83")

cor_nocondenseREF <- c("Method: Pearson",
                       "full data n: 17606",
                       "n used: 14816",
                       "", 
                       "Correlation: 0.1783",
...
stdCoefREF <- c("                               coef     se       t   dof  Pr(>|t|)  stdCoef    stdSE", 
...
assignTableREF <- structure(c(8486L, 0L, 0L, 8429L),
                            .Dim = c(2L, 2L),
                            .Dimnames = structure(list(c("Male", "Female"),
                                                       c("Male", "Female")),
                            .Names = c("", "")), class = "table")
...
mmlSumREF <- c("Call:", 
               ...
               "(Intercept)  279.405   0.821 340.366  28   <2e-16 ***",             
               "---", 
               "Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1",
               "", 
               "Residual Variance Estimate:", 
               "              Estimate StdErr", 
               "Population SD    34.85 0.5451",
               "",                                                                
