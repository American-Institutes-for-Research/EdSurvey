...
*  You can use the [styler](https://CRAN.R-project.org/package=styler) package to style your code, but please don't restyle code that has nothing to do with your PR.  
